                                            ...
                                            <div class="rbt-dashboard-table table-responsive mobile-table-750">
                                                <table class="rbt-table table table-borderless">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="b3">Course: <a href="#">Speaking Korean for Beginners</a></span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>June 30, 2022</td>
                                                        <td>
                                                            <span class="b3">Course: <a href="#">PHP for Beginners</a></span>
                                                            <div class="rbt-review">
                                                                <div class="rating">
                                                                    <i class="fas fa-star"></i>
                                                                    <i class="fas fa-star"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>April 30, 2022</td>
                                                        <td>
                                                            <span class="b3">Course: <a href="#">WordPress for Beginners</a></span>
                                                            <div class="rbt-review">
                                                                <div class="rating">
                                                                    <i class="fas fa-star"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>March 30, 2022</td>
                                                        <td>
                                                            <span class="b3">Course: <a href="#">Design for Beginners</a></span>
                                                            <div class="rbt-review">
                                                                <div class="rating">
                                                                    <i class="fas fa-star"></i>
                                                                    <i class="fas fa-star"></i>
