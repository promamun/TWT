            ...
            <div class="col-md-12 pb--120 pt--70">
                <div class="content">
                    <div class="inner">
                        ...
                        <h1 class="title">We Help You Write<br>
                            <span class="header-caption">
                                    <span class="cd-headline clip is-full-width">
                                        <span class="cd-words-wrapper">
                                            <b class="is-visible theme-gradient">Blogs.</b>
                                            <b class="is-hidden theme-gradient">Books.</b>
                                            <b class="is-hidden theme-gradient">Articles.</b>
                                            <b class="is-hidden theme-gradient">Guest Blog Posts.</b>
                                            <b class="is-hidden theme-gradient">Website Contents.</b>
                                            <b class="is-hidden theme-gradient">Email Campaigns.</b>
                                            <b class="is-hidden theme-gradient">Social Media Posts.</b>
                                        </span>
                                </span>
                            </span>
                        </h1>
                        <p class="description">
                            Increasing Confidence, Clarity & Publicity for Self-Made Industry Leaders and Influencers Who Want to Uplevel Their Expert Status Through Real,
                            <strong>Story-Based Written Content.</strong>
                        </p>
                        <div class="slider-btn">
                            <a class="rbt-btn btn-gradient hover-icon-reverse" href="{{url('/all-courses')}}">
                    ...
                    <div class="shape-wrapper" id="scene">
                        <img src="{{asset('/frontend/')}}/assets/image/the-write-toolbox.png" alt="Hero Image">
                        <div class="hero-bg-shape-1 layer" data-depth="0.4">
                            <img src="{{asset('/frontend/')}}/assets/images/shape/shape-01.png" alt="Hero Image Background Shape">
                        </div>
                        <div class="hero-bg-shape-2 layer" data-depth="0.4">
                            <img src="{{asset('/frontend/')}}/assets/images/shape/shape-02.png" alt="Hero Image Background Shape">
                        </div>
                    </div>
