                                ...
                                <div class="rbt-header-top-news">
                                    <div class="inner">
                                        <div class="content">
                                            ...
                                            <span class="news-text"><img src="{{asset('/frontend/')}}/logo.png" alt=""> Intro price. Get Histudy for Big Sale -95% off.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="mainbar-row rbt-navigation-center align-items-center">
                <div class="header-left rbt-header-content">
                    <div class="header-info">
                        <div class="logo">
                            <a href="{{url('/')}}">
                                <img src="{{asset('/frontend/')}}/logo.png" alt="Education Logo Images">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <nav class="mainmenu-nav">
                        <ul class="mainmenu">
                            <li class="with-megamenu has-menu-child-item position-static">
                                <a href="{{url('/')}}">Home <i class="feather-chevron-down"></i></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{url('/terms-of-condition')}}">Terms of Use</a>
                            </li>
                        </ul>
                    </nav>
                </div>
