                    ...
                    <div class="row gy-5 align-items-end">
                        ...
                        <div class="col-lg-6 rbt-title-style-3">
                            <div class="call-to-btn text-start text-lg-end position-relative">
                                <a @if($policyCount > 0) disabled="disabled" @endif class="rbt-btn btn-sm rbt-switch-btn rbt-switch-y" href="{{url('/twt/privacy/policy/create')}}">
                                    <span data-text="Add Policy"> Add Privacy Policy</span>
                                </a>
