        ...
        <div class="rbt-dashboard-content bg-color-white rbt-shadow-box">
            <div class="content">
                    ...
                    <div class="row gy-5 align-items-end">
                        ...
                        <div class="col-lg-6 rbt-title-style-3">
                            <div class="call-to-btn text-start text-lg-end position-relative">
                                <a class="rbt-btn btn-sm rbt-switch-btn rbt-switch-y" href="{{url('/twt/terms/of/use/create')}}">
                                    <span data-text="Add New About"> Add New Terms</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="rbt-dashboard-table table-responsive mobile-table-750 mt--30">
                    ...
                    @endif
                    <form action="{{url('/twt/terms/of/use/store')}}" method="post">
                        @csrf
