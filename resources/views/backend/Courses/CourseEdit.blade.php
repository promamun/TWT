            ...
            <div class="content">
                ...
                <div class="rbt-dashboard-table table-responsive mobile-table-750 mt--30">
                    <div class="wrapper">
                        ...
                        @endif
                        <form action="{{url('/twt/course/update/'.$course->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-5">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="rbt-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="#">
                                                    <img id="uploaded_image" src="{{asset('/course/'.$course->image)}}" alt="blog image">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="description" required id="blog">{{$course->description}}</textarea>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="learn" required id="learn">{{$course->learn}}</textarea>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input  name="price" value="{{$course->price}}" required type="text">
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="rbt-modern-select bg-transparent height-45 w-100">
                                        <select required name="status" class="w-100" data-live-search="true" title="Select status" data-size="7" data-actions-box="true" data-selected-text-format="count > 5">
                                            <option selected value="{{$course->status}}">{{$course->status}}</option>
